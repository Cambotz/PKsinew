...
SPRITE_PACKS = [
    ...
    {
        "id": "gen1_rb_transparent",
        "display_name": "Gen I - Red/Blue (Transparent)",
        "description": "Red/Blue sprites with transparent background. No ugly white box.",
        "preview_normal_url": f"{_BASE}/versions/generation-i/red-blue/transparent/25.png",
        "preview_shiny_url": None,
        "normal_url_pattern": f"{_BASE}/versions/generation-i/red-blue/transparent/{{id}}.png",
        "shiny_url_pattern": None,
        "has_shiny": False,
        "file_ext": "png",
        "note": "No shiny variants in Gen I",
    ...
    {
        "id": "gen1_yellow_transparent",
        "display_name": "Gen I - Yellow (Transparent)",
        "description": "Yellow sprites with transparent background. Clean on any colour.",
        "preview_normal_url": f"{_BASE}/versions/generation-i/yellow/transparent/25.png",
        "preview_shiny_url": None,
        "normal_url_pattern": f"{_BASE}/versions/generation-i/yellow/transparent/{{id}}.png",
        "shiny_url_pattern": None,
        "has_shiny": False,
        "file_ext": "png",
        "note": "No shiny variants in Gen I",
    ...
    {
        "id": "gen2_gold_transparent",
        "display_name": "Gen II - Gold (Transparent)",
        "description": "Gold sprites with transparent background. Shiny included.",
        "preview_normal_url": f"{_BASE}/versions/generation-ii/gold/transparent/25.png",
        "preview_shiny_url": f"{_BASE}/versions/generation-ii/gold/transparent-shiny/25.png",
        "normal_url_pattern": f"{_BASE}/versions/generation-ii/gold/transparent/{{id}}.png",
        "shiny_url_pattern": f"{_BASE}/versions/generation-ii/gold/transparent-shiny/{{id}}.png",
        "has_shiny": True,
        "file_ext": "png",
    },
    {
        "id": "gen2_silver_transparent",
        "display_name": "Gen II - Silver (Transparent)",
        "description": "Silver sprites with transparent background. Shiny included.",
        "preview_normal_url": f"{_BASE}/versions/generation-ii/silver/transparent/25.png",
        "preview_shiny_url": f"{_BASE}/versions/generation-ii/silver/transparent/shiny/25.png",
        "normal_url_pattern": f"{_BASE}/versions/generation-ii/silver/transparent/{{id}}.png",
        "shiny_url_pattern": f"{_BASE}/versions/generation-ii/silver/transparent/shiny/{{id}}.png",
        "has_shiny": True,
        "file_ext": "png",
    },
    {
        "id": "gen2_crystal_transparent",
        "display_name": "Gen II - Crystal (Transparent)",
        "description": "Crystal sprites with transparent background. Shiny included.",
        "preview_normal_url": f"{_BASE}/versions/generation-ii/crystal/transparent/25.png",
        "preview_shiny_url": f"{_BASE}/versions/generation-ii/crystal/transparent/shiny/25.png",
        "normal_url_pattern": f"{_BASE}/versions/generation-ii/crystal/transparent/{{id}}.png",
        "shiny_url_pattern": f"{_BASE}/versions/generation-ii/crystal/transparent/shiny/{{id}}.png",
        "has_shiny": True,
        "file_ext": "png",
    },
    {
        "id": "gen2_crystal_animated",
        "display_name": "Gen II - Crystal Animated",
        "description": "Crystal GBC sprites as animated GIFs. The only animated Gen II sprites.",
        "preview_normal_url": f"{_BASE}/versions/generation-ii/crystal/animated/25.gif",
        "preview_shiny_url": f"{_BASE}/versions/generation-ii/crystal/animated/shiny/25.gif",
        "normal_url_pattern": f"{_BASE}/versions/generation-ii/crystal/animated/{{id}}.gif",
        "shiny_url_pattern": f"{_BASE}/versions/generation-ii/crystal/animated/shiny/{{id}}.gif",
        "has_shiny": True,
        "file_ext": "gif",
